...
for(const lang of ['en','ro']){
 ...
 if(mainQuestionCount!==10||new Set(survey.questions.map(q=>q.id)).size!==survey.questions.length)throw new Error('v3 requires ten main questions and unique follow-up IDs');
...
console.log('Built bilingual v3 questionnaire: 10 questions with conditional follow-ups, 4 sections, English administration.');
