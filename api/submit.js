...
import { survey, getQuestions, answerError, participantFields, participantError } from '../public/survey-config.js';
...
export function validateSubmission(data) {
 ...
 const identityError=participantError(data.participant,language);if(identityError)fail(identityError);
